  ...
  return (
    <>
      ...
      <div className="min-h-screen items-center justify-center">
        <header className="bg-gradient-to-b from-background via-background to-accent w-full mx-auto min-h-[20vh] pt-[20vh] pb-[12vw]">
          <div className="flex items-center justify-center mb-[6vh] relative">
            <h1 className="text-[8rem] font-bold mb-[6vh] text-center text-foreground flex-1">Realityware</h1>
        ...
        <main className="w-full p-8 bg-accent mx-auto">
          ...
          <section className="space-y-4 flex mt-[10vh]">
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-secondary bg-secondary rounded-lg shadow-lg border-[2vw] rounded text-center text-lightblack text-white">Step 1: Come up with an idea! <span className="block mt-4 text-sm text-justify">It can be anything, as well as a solution can be built for it! The better your idea is to help society, the better reward you will get!</span></p>
            <div className="w-[8vw] h-[6vh] bg-secondary flex-shrink-0 my-[18vh]"></div>
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-foreground bg-foreground rounded-lg shadow-lg border-[2vw] rounded text-lightblack text-center text-white">Step 2: Build your project! <span className="block mt-4 text-sm text-justify">Design your project! Plan it out, make a CAD, and design the schematic! Then, create the code that your project would run on, and put it on GitHub!</span></p>
            <div className="w-[8vw] h-[6vh] bg-foreground flex-shrink-0 my-[18vh]"></div>
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-primary bg-primary rounded-lg shadow-lg border-[2vw] rounded text-lightblack text-center text-lg">Step 3: Create your BOM! <span className="block mt-4 text-sm text-justify">Simply list out all the components and materials you will need to create your project. We will use this BOM to give you an appropriate grant!</span></p>
          </section>
          <section className="space-y-4 gap-[10vw] flex mt-[15vh] justify-center items-center">
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-blue-900 bg-blue-900 border-[2vw] rounded-lg shadow-lg rounded text-lightblack text-center text-white">Optional: Create a PCB layout for your project! <span className="block mt-4 text-sm text-justify">For a chance at bigger rewards, create a PCB design for your project! This will become a part of your grant.</span></p>
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-purple bg-purple border-[2vw] rounded-lg shadow-lg rounded text-lightblack text-center text-lg">Step 4: Ship it! <span className="block mt-4 text-sm text-justify">Once you're finished, ship it to us! We'll rate your project and give you a grant to build it.</span></p>
          </section>
          <section className="space-y-4 gap-[10vw] flex mt-[15vh] justify-center items-center">
            <p className="inline-block w-[25vw] h-64 px-4 py-3 border border-background bg-background border-[2vw] rounded-lg shadow-lg rounded text-lightblack text-center text-lg">Step 5: Use your grant to build your project!<span className="block mt-4 text-sm text-justify">The project isn't finished until it's up and working! You can win even more prizes by doing so!</span></p>
          </section>
